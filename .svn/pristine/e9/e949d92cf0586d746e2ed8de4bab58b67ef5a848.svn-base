...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      select: function(arg) {
    	  ...
    	  $("#frm01 [name=start]").val(arg.start.toISOString().substring(0, 10))
    	  //$("#frm01 [name=start]").val(arg.start.toISOString().substring(0, arg.start.toISOString().indexOf("T") + 6))
    	  $("#frm01 [name=end]").val(arg.end.toISOString().substring(0, 10))
    	  //$("#frm01 [name=end]").val(arg.end.toISOString().substring(0, arg.end.toISOString().indexOf("T") + 6))
  ...
  function formData(event){
 	  ...
 	  $("#frm01 [name=start]").val(event.start.toISOString().substring(0, 10))
 	  //$("#frm01 [name=start]").val(arg.start.toISOString().substring(0, arg.start.toISOString().indexOf("T") + 6))
 	  if(event.end!=null){
	  	//$("#frm01 [name=end]").val(event.end.toISOString())
	  	$("#frm01 [name=end]").val(event.end.toISOString().substring(0, 10))
 	  }else{
 		 //$("#frm01 [name=end]").val(arg.start.toISOString().substring(0, arg.start.toISOString().indexOf("T") + 6))
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form id="frm01" class="form">
	     ...
	     <div class="row">
	      <div class="col">
	        <input type="date" class="form-control"  data-bs-toggle="tooltip"  title="시작일" name="start">
	      </div>
	      <div class="col">
	        <input type="date" class="form-control"  data-bs-toggle="tooltip"  title="종료일" name="end">
	      </div>
	     </div>
	     <div class="row">
	      <div class="col"> 
